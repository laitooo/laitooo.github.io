...
const JopCard = (probs: { job: Jop }) => {
    return (
        <li className="mb-10 ml-4">
            ...
            <time className="mb-1 text-base md:text-lg font-normal leading-none text-white">{probs.job.startDate} - {probs.job.endDate}</time>
            ...
            <p className="mb-4 text-lg md:text-xl font-normal text-white pt-3">{probs.job.details}</p>
        </li>
    );
}
